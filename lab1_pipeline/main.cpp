...
void fbRender(GLfloat currentTime, glm::mat4 viewMatrix);
...
} rockStruct, groundStruct, towerStruct, fanStruct, lightModel;
...
#pragma region framebuffer
    ...
    string dvs_text = readShader("vs_framebuffer.glsl"); const char* dvs_source = dvs_text.c_str();
    ...
    string dfs_text = readShader("fs_framebuffer.glsl"); const char* dfs_source = dfs_text.c_str();
...
void render(GLfloat currentTime) {
    ...
    fbRender(currentTime, viewMatrix);
